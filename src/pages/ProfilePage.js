             ...
             <MDBRow>
              <MDBCol>
                <MDBBreadcrumb className="bg-light rounded-3 p-3 mb-4" style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                  <h2>User Profile</h2>
                  <div>
                    <Button onClick={handleHistory} className="btn btn-outline-success btn-light m-2"><i className="fas fa-history"></i> ORDERS HISTORY</Button>
                    <UpdateProfileModal/>
                  </div>
                </MDBBreadcrumb>
              </MDBCol>
       ...
       <MDBContainer className="py-5">
        ...
        <MDBCol>
          <MDBBreadcrumb className="bg-light rounded-3 p-3 mb-4" style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
            <h2>Order History</h2>
            <div>
              <Button onClick={handleHistory} className="btn btn-outline-success btn-light m-2"><i className="fas fa-user"></i> Profile</Button>
            </div>
          </MDBBreadcrumb>
        </MDBCol>
        </MDBRow>
